...
- CIM-Analysis-SCORING-CRITERIA.xlsx in CIM Analysis/ folder
...
Use CIM-Analysis-SCORING-CRITERIA.xlsx. Score each criterion 1-5. Calculate weighted total. Record scores directly in the screening report table.
